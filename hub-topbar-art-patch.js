// Beastward illustrated Sanctuary topbar v3
(()=>{
 const V='20260915-topbar-art-3';
 ...
 `;document.head.appendChild(st);document.documentElement.dataset.hubTopbarArt='v3';
})();