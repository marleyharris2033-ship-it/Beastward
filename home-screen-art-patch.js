// BeastBorn illustrated home screen v1
(() => {
  if (window.__beastbornIllustratedHomeV1) return;
  window.__beastbornIllustratedHomeV1 = true;
  ...
  style.textContent = `
    ...
    #titleScreen.illustrated-home .title-shell{
      ...
      background-image:url('assets/home-bg/beastborn-home.webp?v=20260911-1')!important;
    ...
    #titleScreen.illustrated-home .title-motto{
    ...
    #titleScreen.illustrated-home #newGameBtn{
      ...
      background:linear-gradient(180deg,rgba(49,91,63,.93),rgba(16,49,32,.96))!important;
      color:#f7e9b2!important;
      box-shadow:inset 0 0 0 1px rgba(255,255,255,.06),0 7px 0 rgba(4,17,10,.88),0 16px 36px rgba(0,0,0,.55),0 0 30px rgba(111,220,142,.12)!important;
    ...
    #titleScreen.illustrated-home #newGameBtn .menu-icon{
      ...
      background:rgba(6,31,18,.88)!important;
      color:#f2d56f!important;
      font-size:20px!important;
      box-shadow:inset 0 0 14px rgba(125,231,154,.14)!important;
    }
    #titleScreen.illustrated-home #newGameBtn b{
    ...
    #titleScreen.illustrated-home #newGameBtn small{
      display:block!important;
      margin-top:4px!important;
      color:#b8c8bc!important;
      font-size:10px!important;
    }
    #titleScreen.illustrated-home #newGameBtn .menu-arrow{
      color:#edd273!important;
      font-size:31px!important;
      text-align:right!important;
    }
    #titleScreen.illustrated-home #newGameBtn:active{
      transform:translateY(3px)!important;
      box-shadow:inset 0 0 0 1px rgba(255,255,255,.06),0 4px 0 rgba(4,17,10,.9),0 9px 22px rgba(0,0,0,.5)!important;
    }
    ...
    @media(orientation:landscape) and (max-height:620px){
      ...
      #titleScreen.illustrated-home #newGameBtn{min-height:56px!important}
    }
  `;
  document.head.appendChild(style);
  document.documentElement.dataset.beastbornHomeArt = 'v1';
})();
